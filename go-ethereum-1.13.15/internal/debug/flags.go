...
import (
	...
	// "github.com/fjl/memsize/memsizeui" // Commented out due to Go version compatibility
...
// var Memsize memsizeui.Handler // Commented out due to Go version compatibility
type DummyMemsizeHandler struct{}

func (h *DummyMemsizeHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
	w.Write([]byte("Memsize handler disabled"))
}

var Memsize = &DummyMemsizeHandler{}
