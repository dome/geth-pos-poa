...
// HybridConfig is the consensus engine config for hybrid PoS to PoA transition.
type HybridConfig struct {
	TransitionBlock uint64        `json:"transitionBlock"`     // Block number to transition from PoS to PoA
	PoAConfig       *CliqueConfig `json:"poaConfig,omitempty"` // PoA configuration for post-transition
}

// String implements the stringer interface, returning the consensus engine details.
func (h *HybridConfig) String() string {
	return "hybrid"
}
